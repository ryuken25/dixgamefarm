        ...
        <div class="col-md-10">
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    foreach ($customers as $c) {
                                        if ($c['total_orders'] > 0) $activeCustomers++;
                                    }
                                    ?>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <input type="text" id="searchCustomer" class="form-control form-control-sm" placeholder="Cari pelanggan..." style="width: 250px;">
                    </div>
                </div>
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="bg-success text-white rounded-circle d-flex align-items-center justify-content-center me-2" style="width: 36px; height: 36px; font-size: 14px;">
                                                        <?= strtoupper(substr(esc($customer['nama_lengkap'] ?? 'P'), 0, 1)) ?>
                                                    </div>
                                                    <div>
                                                        <span class="fw-bold"><?= esc($customer['nama_lengkap'] ?? '-') ?></span>
                                                        <?php if ($customer['total_spent'] > 0 && $no <= 4): ?>
                                                            <span class="badge bg-warning text-dark ms-1" title="Pelanggan Teratas"><i class="bi bi-star-fill"></i></span>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-end">
                                                <?php if ($customer['total_spent'] > 0): ?>
                                                    <span class="fw-bold text-success">Rp <?= number_format($customer['total_spent'], 0, ',', '.') ?></span>
                                                <?php else: ?>
                    ...
                    <?php if (!empty($customers)): ?>
                        <div class="text-muted small mt-2">
                            ...
                            Data pesanan hanya menghitung pesanan dengan status Diproses, Dikirim, dan Selesai.
                        </div>
                    <?php endif; ?>
                </div>
            </div>
